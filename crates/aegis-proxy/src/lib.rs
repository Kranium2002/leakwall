...
use aegis_secrets::scanner::ScanResult;
...
pub struct ProxyState {
    pub scanner: Arc<aegis_secrets::scanner::SecretScanner>,
    ...
    /// Random token for proxy authentication (Basic auth with username "aegis").
